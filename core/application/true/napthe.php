...
echo thongbao('Vui lòng nhập đủ thông tin','loi');
     ...
     $code = random(7);
            ...
            $site_callback = ''.$system->data->callback.'';
                    ...
                    $json = json_decode(curl_get('https://cardvip365.com/api/card-auto.php?auto=true&type='.$_POST['telco'].'&menhgia='.$_POST['amount'].'&seri='.$_POST['serial'].'&pin='.$_POST['code'].'&APIKey='.$site_api.'&callback='.$site_callback.'&content='.$code.''), true);
